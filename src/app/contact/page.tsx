...
export default function Contact() {
  ...
  return (
    <ContainerPage key="contact-page">
      <main
        className={`sm:col-span-4 sm:col-start-3 sm:row-start-1 min-h-screen sm:my-28 my-16 mx-4 text-white`}
      >
        <div className="text-3xl font-semibold">Contact</div>
        <div className="text-sm mt-1 text-white/60">
          Everyone, please contact me for work-related matters through this
          form.
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          <div>
            ...
            <input
              ...
              className={`w-[98%] mx-2 block border-none p-4 mb-4 rounded-md mt-4 outline-none  ${
                mode ? "bg-white" : "bg-[#141414]"
              }`}
              required
            />
          </div>
          <div>
            ...
            <input
              ...
              className={`w-[98%] mx-2 block border-none p-4 mb-4 rounded-md mt-4 outline-none bg-[#141414] ${
                mode ? "bg-white" : ""
              }`}
              required
            />
          ...
          <div className="flex justify-center flex-col mx-4">
            <div className="text-sm text-white/60 mb-2">
              Note: Please complete the captcha before submitting!{" "}
            </div>
            <HCaptcha
